  ...
  return (
    <div>
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        {/* <!-- Carousel controls --> */}
        <a class="carousel-control-prev" href="#myCarousel" data-slide="prev" rel="noopener noreferrer">
          <i class="fa fa-angle-left"></i>
        </a>
        <a class="carousel-control-next" href="#myCarousel" data-slide="next" rel="noopener noreferrer">
